...
export function AppHeader() {
  ...
  const navigation = [
    ["/mi-aprendizaje", "Mi aprendizaje"], ["/academias", "Academias"], ["/bid-it", "Bid It!"], ["/admin", "Administración"],
  ];
  return (
    <>
