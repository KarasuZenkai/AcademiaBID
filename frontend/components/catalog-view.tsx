...
export function CatalogView() {
  ...
  if (!academies.length) return <div className="app-card p-6"><h2 className="font-semibold text-slate-800">Aún no tienes aprendizaje asignado</h2><p className="mt-2 text-sm text-slate-500">Tu responsable o Talento Humano podrá asignarte una academia, ruta o curso desde Administración.</p></div>;
